...
from control.srv import calculateDimension
...
class calculateDimension:
    def __init__(self):
        ...
        # self.serv = rospy.Service('calculate_dimension', calculateDimension, self.calculate_dimension)
        self.set_object_serv = rospy.Service('set_object', calculateDimension, self.calculate_dimension)
        self.length = 0
        self.width = 0
        self.height = 0
